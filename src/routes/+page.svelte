	...
	{:else}
		...
		<div class="flex flex-col items-center justify-center py-20">
			...
			<button
				...
				class="mt-6 rounded-lg border border-gray-600 px-5 py-2 text-sm text-gray-300 transition hover:border-accent-purple hover:text-white focus-visible:ring-2 focus-visible:ring-accent-purple focus-visible:outline-none"
			>
				Clear all filters
			</button>
		</div>
