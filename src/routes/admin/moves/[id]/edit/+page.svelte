...
<div class="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
	...
	{#if showDeleteConfirm}
		<div class="bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black p-4">
			<div class="max-w-md rounded-lg bg-[#242736] p-6 shadow-xl">
				<h3 class="mb-4 text-lg font-semibold text-white">
					Delete "{data.move.name}"?
				</h3>
				<p class="mb-6 text-sm text-[#A0A5C0]">
				...
				<div class="flex gap-3">
					...
					<button
						...
						class="flex-1 rounded-lg border border-gray-600 px-4 py-2 text-sm font-medium text-[#A0A5C0] transition-colors hover:bg-white/5"
					>
						Cancel
					</button>
				</div>
		...
		<div class="rounded-lg border border-gray-800 bg-[#242736] p-6 shadow-sm">
			...
			<div class="mb-4">
				...
				<input
					...
					class="w-full rounded-lg border border-gray-600 bg-[#242736] px-3 py-2 text-gray-200 placeholder-[#A0A5C0] focus:border-[#8A63F8] focus:ring-1 focus:ring-[#8A63F8] focus:outline-none"
				/>
			</div>
		...
		<div class="rounded-lg border border-gray-800 bg-[#242736] p-6 shadow-sm">
			...
			<div class="mb-4">
				...
				{#if imagePreview && !removeImage}
					<div class="mb-4">
						<p class="mb-2 text-sm font-medium text-[#A0A5C0]">Current Image:</p>
				...
				<input
					...
					class="w-full rounded-lg border border-gray-600 bg-[#242736] px-3 py-2 text-gray-200 file:mr-4 file:rounded-md file:border-0 file:bg-purple-500/20 file:px-4 file:py-1.5 file:text-sm file:font-medium file:text-purple-300 hover:file:bg-purple-500/30"
				/>
				<p class="mt-1 text-xs text-[#A0A5C0]">
					{#if imagePreview && !removeImage}
