...
export const load: PageServerLoad = async (event) => {
	...
	// Performance: Optimized query using LEFT JOIN and GROUP BY to fetch categories and move counts in a single operation.
	// This reduces data transfer by avoiding redundant category IDs and eliminates the need for manual in-memory merging.
	// Lean Query: Selective field fetching ensures only necessary metadata (id, name, createdAt) and aggregated move counts are fetched.
