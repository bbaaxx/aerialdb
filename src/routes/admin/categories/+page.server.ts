...
export const load: PageServerLoad = async (event) => {
	...
	// Performance: Optimize category management by using a single query with LEFT JOIN and GROUP BY.
	// This reduces the complexity from two separate queries (even if batched) to one,
	// and eliminates the need for manual in-memory merging of move counts.
