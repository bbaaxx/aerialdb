...
export const load: PageServerLoad = async (event) => {
	...
	// Performance: Optimized query using LEFT JOIN to fetch categories and their move counts in a single query.
	// This reduces database round-trips and simplifies application-layer merging logic.
	// Using count(moves.id) ensures categories with 0 moves are correctly counted as 0 (not 1).
