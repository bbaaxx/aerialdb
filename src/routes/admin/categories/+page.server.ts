...
export const load: PageServerLoad = async (event) => {
	...
	// Performance: Single optimized query using LEFT JOIN and GROUP BY to fetch categories
	// and their associated move counts in one round-trip, eliminating manual merging.
