...
export const load: PageServerLoad = async (event) => {
	...
	// Performance: Optimized query using LEFT JOIN and GROUP BY to fetch categories and their move counts
	// in a single database round-trip. This is more efficient than batching multiple queries and
	// merging them in-memory, as it reduces both network overhead and server-side processing.
