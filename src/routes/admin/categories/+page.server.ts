...
export const load: PageServerLoad = async (event) => {
	...
	// Performance: Optimized query using LEFT JOIN and GROUP BY to aggregate move counts in a single pass.
	// This eliminates the need for db.batch() and manual in-memory data merging,
	// reducing both network round-trip overhead and server-side processing.
