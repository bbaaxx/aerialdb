...
export const load: PageServerLoad = async (event) => {
	...
	// Performance: Use a single optimized query with LEFT JOIN and GROUP BY to fetch categories and their move counts.
	// This reduces database execution overhead and avoids the need for manual in-memory merging,
	// while still minimizing network round-trips to Cloudflare D1.
