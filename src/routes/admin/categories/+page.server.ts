...
export const load: PageServerLoad = async (event) => {
	...
	// Performance: Optimized query using LEFT JOIN and GROUP BY to fetch categories and their move counts in one go.
	// This reduces server-side processing overhead (no in-memory map merging) and remains efficient on Cloudflare D1.
