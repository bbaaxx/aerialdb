...
export const load: PageServerLoad = async (event) => {
	...
	// Performance: Optimized query using LEFT JOIN and GROUP BY to fetch categories and their move counts in one round-trip.
	// This reduces database payload and eliminates the need for in-memory merging logic.
	// Lean Query: Selecting only the fields needed for the category management page
