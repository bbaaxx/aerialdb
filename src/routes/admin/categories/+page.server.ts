...
export const load: PageServerLoad = async (event) => {
	...
	// Performance: Optimized into a single query using LEFT JOIN and GROUP BY.
	// This reduces database execution overhead and simplifies the server-side merging logic.
	// We use count(moves.id) to ensure categories with 0 moves are correctly reported as 0.
