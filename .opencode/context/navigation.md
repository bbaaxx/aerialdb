...
**New here?** → `openagents-repo/guides/quick-start.md`
...
**content-creation/** - Content creation (all formats) → content-creation navigation (currently unavailable)
**data/** - Data engineering → `development/data/navigation.md`
**product/** - Product management → product navigation (currently unavailable)
**learning/** - Educational → learning navigation (currently unavailable)
