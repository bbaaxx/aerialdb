...
| **Operations & procedures**   | `operations/harvest.md`           |
| **Implementation guides**     | `guides/workflows.md`             |
| **Standards & templates**     | `standards/templates.md`          |
| **Examples**                  | `examples/navigation-examples.md` |
