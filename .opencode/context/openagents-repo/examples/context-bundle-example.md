...
- `.opencode/context/openagents-repo/guides/quick-start.md` → Repo orientation and common commands

**Core Concepts** (Load based on task type):
- `.opencode/context/openagents-repo/concepts/agents.md` → How agents work
- `.opencode/context/openagents-repo/concepts/evals.md` → How testing works
- `.opencode/context/openagents-repo/concepts/registry.md` → How registry works
- `.opencode/context/openagents-repo/concepts/categories.md` → How organization works
