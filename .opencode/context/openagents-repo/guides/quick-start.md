...
1. **Agents** → Load: `../concepts/agents.md`
   - How agents are structured
   - Category system
   - Prompt variants
   - Subagents vs category agents

2. **Evals** → Load: `../concepts/evals.md`
   - How testing works
   - Running tests
   - Evaluators
   - Session collection

3. **Registry** → Load: `../concepts/registry.md`
   - How components are tracked
   - Auto-detect system
   - Validation
   - Install system

4. **Categories** → Load: `../concepts/categories.md`
...
| ----------------------- | -------------------------------------------------------------------------------------------- |
| Add a new agent         | `../concepts/agents.md` + `adding-agent-basics.md`                                           |
| Test an agent           | `../concepts/evals.md` + `testing-agent.md`                                                  |
| Fix registry            | `../concepts/registry.md` + `updating-registry.md`                                           |
| Debug issue             | `debugging.md`                                                                               |
| Find files              | `../lookup/file-locations.md`                                                                |
| Create release          | `creating-release.md`                                                                        |
| Write content or copy   | `../concepts/categories.md` + content creation principles navigation (currently unavailable) |
| Use Claude Code helpers | `../concepts/agents.md` + `adding-agent-basics.md`                                           |
...
| Test fails                | Load `debugging.md`                                       |
| Can't find file           | Load `../lookup/file-locations.md`                        |
| Install fails             | Check: `which curl jq`                                    |
| Path resolution issues    | Check `../concepts/categories.md`                         |

---

## Next Steps

1. **First time?** → Read `../concepts/agents.md`, `../concepts/evals.md`, `../concepts/registry.md`
2. **Adding agent?** → Load `adding-agent-basics.md`
3. **Testing?** → Load `testing-agent.md`
4. **Need details?** → Load specific files from `../concepts/` or `../guides/`
