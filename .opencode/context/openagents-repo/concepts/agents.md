...
# (See guides/adding-agent-basics.md for details)
```
...
- **Category system**: `concepts/categories.md`
- **File locations**: `lookup/file-locations.md`
- **Claude Code docs**: Subagents, skills, hooks, and plugins documentation is external and not vendored in this repository.
